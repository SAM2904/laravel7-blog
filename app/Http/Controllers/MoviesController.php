...
class MoviesController extends Controller
{
    ...
    {
        $genres = ['Action', 'Comedy', 'Adventure', 'Biopic', 'Horror', 'Drama'];
    ...
    public function store(Request $request)
    {
        ...
        'genre'=> 'required',
        'poster'=> 'required|image|mimes:jpg,png,jpeg,gif|max:2048',
        ]);
        ...
        $data->save();
        return redirect()->route('movies.index')->with('success','Movie has been added succesfully.');
