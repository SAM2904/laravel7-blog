    ...
    <div class="wrapperdiv">
            <div class="formcontainer">
                ...
                <div class="alert alert-danger">
                    <strong>Oops! There was some problems with your input.</strong>
                    <ul>
                ...
                <form action="{{ route('movies.update', $movie->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group row">
                                <label for="release_year" class="col-sm-2 col-form-control">Release_year</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2 col-form-control"></div>
                                <div class="col-sm-10">
